...
local Themes = {
	Light = {
		MainFrame = Color3.fromRGB(124,37,255),
		Minimise = Color3.fromRGB(255,37,255),
		MinimiseAccent = Color3.fromRGB(255,37,255),
		Maximise = Color3.fromRGB(255,255,255),
		MaximiseAccent = Color3.fromRGB(22,2,85),
		NavBar = Color3.fromRGB(22,2,85),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(22,2,85),
		TitleBarAccent = Color3.fromRGB(145,100,212),
		Overlay = Color3.fromRGB(22,2,85),
		Banner = Color3.fromRGB(72,15,158),
		BannerAccent = Color3.fromRGB(22,2,85),
		Content = Color3.fromRGB(124,37,255),
		Button = Color3.fromRGB(124,37,255),
		ButtonAccent = Color3.fromRGB(124,37,255),
	...
	Mocha = {
		MainFrame = Color3.fromRGB(50,158,212),
		Minimise = Color3.fromRGB(255,106,0),
		MinimiseAccent = Color3.fromRGB(147,59,0),
		Maximise = Color3.fromRGB(25,255,0),
		MaximiseAccent = Color3.fromRGB(0,255,110),
